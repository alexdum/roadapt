      ...
      fluidRow(
        column(
          ...
          conditionalPanel(
            ...
            sliderInput(
              "slider_climgen_absol_gen", label = "Interval calcul", min = 1901, 
        ...
        column(
          ...
          wellPanel(
            leafletOutput("climgen_map_gen") |> withSpinner(size = 0.5)
          ),
          br(),
      ...
      fluidRow(
        column(
          ...
          conditionalPanel(
            ...
            sliderInput(
              "slider_climgen_absol_det", label = "Interval calcul", min = 1901, 
              max = 2025, value = c(1971, 2000), dragRange = T, ticks = F,
              sep = "", step = 1)
          ),
          sliderInput(
